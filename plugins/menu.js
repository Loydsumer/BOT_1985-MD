...
let handler = async (m, { conn, usedPrefix, command }) => {
              ...
              sections: [
                {
                  ...
                  rows: [
                    ...
                    { header: "", title: "قـسـم الـديـن", description: "...", id: ".ق7" },
  ...
  await conn.sendMessage(m.chat, {
    ...
    footer: [
      ...
      `│رقـم الـمـسـتـخـدم: ${m.sender.split('@')[0]}`,
      `│وقـت تـشـغـيـل: ${uptime}`,
      `│بـرفـكـس: ${usedPrefix}`,
      `│لـفـل الـمـسـتـخـدم: ${level}`,
      `╰─────────🌑`,
      `> *❑┊•≫ ࢪابــط الـقـنـاة↶*`,
...
handler.help = ['menu2']
handler.tags = ['owner']
handler.command = /^(اوامر|menu|منيو|الأوامر)$/i
handler.owner = true
